...
enum {fsm_hold, fsm_swing1, fsm_swing2, fsm_stop}; // declaring fsm_states

const double t_hold = 0.5;
const double t_swing1 = 1.0;
const double t_swing2 = 1.5;
...
// Initialising the FSM. Only called once.
